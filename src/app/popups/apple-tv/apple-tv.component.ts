...
export class AppleTvComponent implements OnInit, OnDestroy {
  ...
  back(): void {
    // Pulse the back join
    CrComLib.pulseDigital('MediaControl.BackButtonPress');
  }

  // Method to handle the play/pause action
  playPause(): void {
    // Pulse the play/pause join
    CrComLib.pulseDigital('MediaControl.PlayButtonPress');
  }

  // Method to handle the menu action
  menu(): void {
    // Pulse the menu join
    CrComLib.pulseDigital('MediaControl.MenuButtonPress');
  }
}
