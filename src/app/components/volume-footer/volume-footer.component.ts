...
@Component({
  standalone: true,
  selector: 'app-volume-footer',
  templateUrl: './volume-footer.component.html',
  styleUrl: './volume-footer.component.scss'
})

export class VolumeFooterComponent implements OnInit, OnDestroy {
  ...
  /* Numeric percentage for display */
  gaugePercent = computed(() => Math.round(this.level() / 655.35));
